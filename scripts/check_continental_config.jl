...
ncdir = "C:/Users/markm/Dropbox/Mark-and-Minmin/Generate_topo/ensemble_topo"
...
# colatitude θ ∈ [0,π]
# longitude ϕ ∈ [0,2π]
cellarea(r, Δϕ, θ₁, θ₂) = (r^2)*Δϕ*abs(cos(θ₁) - cos(θ₂))

##

fn = joinpath(ncdir, "topo_ens_n12_p-3.0_001.nc")
lat = ncread(fn, "lat")
lon = ncread(fn, "lon")
...
#land area
L = 0.0
for i ∈ 1:size(topo,1), j ∈ 1:size(topo,2)
